...
public class beansMod implements ModInitializer {
    ...
    //Texture will go in texture/mob_effect <-- not true
    //public static final Potion COFFEE = new Potion(new StatusEffectInstance[]{new StatusEffectInstance(COFFEE_EFFECT, 3600)});
    public static final coffeeItem COFFEE = new coffeeItem(new Item.Settings().group(ITEM_GROUP));
    ...
    public void onInitialize() {
        ...
        Registry.register(Registry.ITEM, new Identifier("beans", "coffee"), COFFEE);
